...
const Header = () => {
  ...
  return (
    <StyledNavbar expand="lg">
      <Container>
        <StyledNavLeft>
          <StyledBrand onClick={() => navigate("/")}>Lucas Gomes</StyledBrand>
        </StyledNavLeft>
        ...
        <Sidebar ref={sidebarRef} show={showSidebar}>
          <Nav className="flex-column">
            ...
            <Nav.Link onClick={() => handleNavigation("/Serviço")}>Serviços</Nav.Link>
            <Dropdown>
              <StyledDropdownToggle variant="link" id="dropdown-curso">
                Curso
              </StyledDropdownToggle>
              <Dropdown.Menu>
                <Dropdown.Item onClick={() => handleNavigation("/Premium")}>Cursos</Dropdown.Item>
                <Dropdown.Item onClick={() => handleNavigation("/MeusCursos")}>Meus Cursos</Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
            <Nav.Link onClick={() => handleNavigation("/QuemSomos")}>Quem Somos</Nav.Link>
            <Nav.Link onClick={() => handleNavigation("/Loja")}>Loja</Nav.Link>
            <Nav.Link onClick={() => handleNavigation("/Contato")}>Contato</Nav.Link>
            <Nav.Link onClick={() => handleNavigation("/Carrinho")}>Carrinho</Nav.Link>
            ...
            <StyledButton onClick={handleAgendarClick}>Agendar Agora</StyledButton>
          </Nav>
        </Sidebar>
