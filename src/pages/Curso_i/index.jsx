...
import masculinoImage from '../../assets/h_i.jpg';
import femininoImage from '../../assets/m_i.jpg';
...
const Treinos = () => {
    return (
        <Container>
            ...
            <Title>Curso</Title>
            <Container_2>
                <Box onClick={() => window.location.href = '/Iniciante_h'}>
                    <WorkoutImage_1 src={masculinoImage} alt="masculino" />
                    <H3>Treino Padrão Masculino Iniciante</H3>
                ...
                <Box onClick={() => window.location.href = '/Iniciante_m'}>
                    <WorkoutImage src={femininoImage} alt="feminino" />
                    <H3>Treino Padrão Feminino Iniciante</H3>
            ...
            <PremiumSection>
                ...
                <PremiumButton onClick={() => window.location.href = '/Selecionar'}>VIRAR PREMIUM</PremiumButton>
            </PremiumSection>
            <Footer />
        </Container>
    );
