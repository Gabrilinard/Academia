...
import masculinoImage from '../../assets/h_it.jpg';
import femininoImage from '../../assets/m_it.jpg';
...
const Treinos = () => {
    return (
        <Container>
            ...
            <Title>Curso</Title>
            <Container_2>
                <Box onClick={() => window.location.href = '/Intermed_h'}>
                    <WorkoutImage_1 src={masculinoImage} alt="masculino" />
                    <H3>Treino Padrão Masculino Intermediário</H3>
                ...
                <Box onClick={() => window.location.href = '/Intermed_m'}>
                    <WorkoutImage src={femininoImage} alt="feminino" />
                    <H3>Treino Padrão Feminino Intermediário</H3>
            ...
            <PremiumSection>
                ...
                <PremiumButton onClick={() => window.location.href = '/Selecionar?modalidade=Intermediário'}>VIRAR PREMIUM</PremiumButton>
            </PremiumSection>
            <Footer />
        </Container>
    );
